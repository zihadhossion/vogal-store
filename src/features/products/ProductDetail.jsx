            ...
            <Modal.Window name={"ask"}>
                <div className='p-3'>
                    ...
                    <form onSubmit={handleForm}>
                        <input type="text" placeholder='Name' value={user_metadata?.fullName} className='w-full block border py-2 px-5 mb-3 capitalize' readOnly />
                        <input type="email" placeholder='Email' value={user_metadata?.email} className='w-full block border py-2 px-5 mb-3' readOnly />
                        <input type="number" placeholder='Phone Number' value={user?.phone} className='w-full block border py-2 px-5 mb-3' readOnly />
